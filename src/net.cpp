...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Konsotami " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"konsotamitools.com", "dnsseed.konsotamitools.com"},
    {"konsotamipool.org", "dnsseed.konsotamipool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"konsotamitools.com", "testnet-seed.konsotamitools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Konsotami is probably already running."), addrBind.ToString().c_str());
        else
